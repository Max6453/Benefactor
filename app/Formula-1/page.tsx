...
const posts = [
  {
    ...
    {
    id: 2,
    title: 'Austrian Grand Prix - Saturday report',
    href: '#',
    description:
    'Saturday was quite interesting with our drivers finishing in top 15',
    date: '23/06/2025',
    datetime: '2025-06-23',
    ...
    {
    id: 3,
    title: 'Friday in Spielberg',
    href: '#',
    image:"/assets/Formula1/Austria-T4.jpg",
    description:
    'Really productive day for engineers and drivers',
    date: '15/06/2025',
    datetime: '2025-06-15',
    category: { title: 'Report', href: '/' },
  },
...
export default function Formula1Page() {
    ...
    <div className="bg-white font-raleway">
            <img src="/assets/Formula1/Austria-T10.jpg"
          ...
          <div className="h-screen">
            <section className="bg-white h-screen snap-start w-300 text-xl">
                  <h1 className="text-6xl pt-10 pl-5">Home of Benefactor Formula 1 Team</h1>
                  <p className="text-wrap  pl-5 pt-15">
                    Since 1987, Benefactor Racing focused on producing championship winning cars.
                    Benefactor racing are holding a record for fastest team to achieve constructors championship with only 1 season after joining the grid in 1988.
                  </p>
                  <p className="text-wrap  pl-5 pt-5">
                    After that season, Benefactor Racing achieved 6 more championships in 1990 - 1992, 1999, 2001 and 2009.
                    Drivers also dominated the season such as Ayrton Senna, Alain prost, Damon Hill or Jenson Button.
                  </p>
                  <p className="text-wrap pl-5 pt-5">
                    Our recent success came in 2018, 2019 and 2020 where after tough fights with mercedes and ferrari finished in 2018 and 2019 in 3th place.
                    In 2020 our engineers made a car which was able to defeat ferrari but insufficient engough for a team from Brackley.
                    We finished in 2nd place. 
                    After major regulations in 2022, Benefactor competed only in midfield but still mamaged to end up in 4th place.
                    In 2023 and 2024, history repeted itself with finishing position in 4th place.
                  </p>
                  <p className="text-wrap pl-5 pt-5">
                    In 2025 our goal is to finish again in best of the rest with big focus on 2026.
                    After few ups and downs season, Benefactor Formula 1 Team set the goal to return to winning ways for 2026 season after a big regulations take place.
